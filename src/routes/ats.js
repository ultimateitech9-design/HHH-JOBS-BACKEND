...
const serializeAtsResult = (analysis = {}) => ({
  ...
  projectEvidenceScore: analysis.projectEvidenceScore,
  domainFitScore: analysis.domainFitScore,
  formatScore: analysis.formatScore,
  impactScore: analysis.impactScore,
  confidenceScore: analysis.confidenceScore,
  resumeWordCount: analysis.resumeWordCount,
  ...
  projectEvidenceLines: analysis.projectEvidenceLines || [],
  projectMatchedKeywords: analysis.projectMatchedKeywords || [],
  ...
  aiInterviewReadiness: analysis.aiInterviewReadiness || '',
  aiFirstFix: analysis.aiFirstFix || '',
  aiRewriteBullets: analysis.aiRewriteBullets || [],
  aiKeywordPlacement: analysis.aiKeywordPlacement || [],
