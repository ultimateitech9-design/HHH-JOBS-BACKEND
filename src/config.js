...
const config = {
  ...
  publicCatalogCacheTtlSeconds: Number(process.env.PUBLIC_CATALOG_CACHE_TTL_SECONDS) > 0 ? Number(process.env.PUBLIC_CATALOG_CACHE_TTL_SECONDS) : 60,
  publicMetadataCacheTtlSeconds: Number(process.env.PUBLIC_METADATA_CACHE_TTL_SECONDS) > 0 ? Number(process.env.PUBLIC_METADATA_CACHE_TTL_SECONDS) : 600,
  memoryCacheMaxEntries: Number(process.env.MEMORY_CACHE_MAX_ENTRIES) > 0 ? Number(process.env.MEMORY_CACHE_MAX_ENTRIES) : 750,
