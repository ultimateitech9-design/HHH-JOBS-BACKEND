<<<<<<< C:/Users/Dipanshu pandey/OneDrive/Desktop/Office Work/project -hhh-job-10days/HHH-JOBS-BACKEND-main/supabase/migrations/005_job_pricing_engine.sql
-- ============================================================
...
insert into public.job_posting_plans (slug, name, price, currency, is_free, is_active, sort_order)
values
  ('hot_vacancy', 'Hot Vacancy', 999, 'INR', false, true, 10),
  ('classified', 'Classified', 699, 'INR', false, true, 20),
  ('standard', 'Standard', 399, 'INR', false, true, 30),
  ('free', 'Free Job Posting', 0, 'INR', true, true, 40)
on conflict (slug) do nothing;
...
using (false)
with check (false);
>>>>>>> C:/Users/Dipanshu pandey/.windsurf/worktrees/project -hhh-job-10days/project -hhh-job-10days-66ffbcdc/HHH-JOBS-BACKEND-main/supabase/migrations/005_job_pricing_engine.sql
