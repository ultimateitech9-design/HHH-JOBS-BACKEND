<<<<<<< C:/Users/Dipanshu pandey/OneDrive/Desktop/Office Work/project -hhh-job-10days/HHH-JOBS-BACKEND-main/supabase/migrations/20260501121500_role_plan_commercial_flow.sql
-- ============================================================
...
values
  (
    ...
    10,
    '["5 standard job postings","Basic recruiter support","Candidate pipeline access"]'::jsonb,
    '{"category":"hr","selfCheckout":true,"defaultTrial":true,"trialEligible":true,"listPrice":999,"trialRenewalPrice":399,"discountText":"After trial ₹399/month","businessFlow":"hr_recruiter_subscription"}'::jsonb
  ),
  (
    'hr_growth',
    'hr',
...
using (false)
with check (false);
>>>>>>> C:/Users/Dipanshu pandey/.windsurf/worktrees/project -hhh-job-10days/project -hhh-job-10days-66ffbcdc/HHH-JOBS-BACKEND-main/supabase/migrations/20260501121500_role_plan_commercial_flow.sql
